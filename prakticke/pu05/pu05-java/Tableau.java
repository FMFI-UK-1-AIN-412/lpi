...
class Tableau {
     ...
     * alpha-subformula of `source` node.
     *
     * @param leaf the (leaf) node to add the new node/formula to
     * @param source the node with an alpha formula which's subformula
     *               will be added
     ...
     * of the beta Node `source`.
     *
     * @param leaf the (leaf) node to add the new node/formula to
     * @param source the node with a beta formula which's subformulas
     *               will be added
