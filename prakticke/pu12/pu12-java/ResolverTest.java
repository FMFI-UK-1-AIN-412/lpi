...
public class ResolverTest {
    ...
    public static void main(String[] args) {
        ...
        t.testIsSatisfiable(true, T("a b; -b -a; c -d; -c d"));
        t.testIsSatisfiable(false, T("-a c; a b; -a -c; -b a"));
        t.testIsSatisfiable(true, T("-a c; a b; -a -c"));
        t.testIsSatisfiable(true, T("a b c; b -c; -a -b"));
        t.testIsSatisfiable(true, T("-a; a -a; a -b; a -c"));
        t.testIsSatisfiable(true, T("a; -a a; -a b; -a c"));
        t.testIsSatisfiable(false, T("-a; a -a; a -b; a -c; b c"));
        t.testIsSatisfiable(false, T("a; -a a; -a b; -a c; -b -c"));
